...
$products = $con->query("
select @rownum:=@rownum+1 AS N,t5.nombre_completo,t5.total_cliente as Monto_Total_Compras
...
<div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h1 class="panel-title text-center">Clientes que no han comprado</h1>
