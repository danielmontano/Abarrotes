...
if($_POST["nombProd"] or $_GET["nombProd"]){
 ...
 <form method="post" action="products.php">
      <select name="idcat">
      <option value = "0">Promociones</option>
...
<div class="panel panel-primary text-center">
     <div class="panel-body text-center">
     <img src="../2017-3-oxtro/a/assets/uploads/files/productos/<?php echo $r->img_prod_beh; ?>" class="img-responsive" style=" align-self: center; height:250px ;width:100%">
      </div>
      <div class="panel-footer text-center">
      <ul class="list-group">
