        ...
        <div class="row row1">
           ...
           <li id="a" class="dropdown" >
              ...
              <ul id="a" class="dropdown-menu" >
                ...
                <li class="divider"></li>
                <li><a id="a" style="color:white" href="#" onclick="window.location='http://oxtro.xyz/2017-3-oxtro/a/';">Administración<span class="glyphicon glyphicon-cog pull-right"></span></a></li>
                <li class="divider"></li>
